...
def filterer(File, timestep, timeframe):
    ...
    if timeframe == 'a':
        ...
        for i in years:
            ...
            for j in months:
                ...
                if df.empty == True:
                    ...
                    if numNaN >= limit_numNaN_a or consecNaN >= limit_consecNaN_a:
        ...
        weeks = [i for i in weeks if i != 0] # Remove the 0 (first element)
        ...
        for i in weeks:
            ...
            if df.empty == True:
                ...
                if numNaN >= limit_numNaN_b or consecNaN >= limit_consecNaN_b:
                    indexInit.append(df.index[0])
                    indexEnd.append(df.index[-1])
